...
async function interact(alreadyComplimented, nullUpTo, guessedYet, lastChat, artist){
    ...
    const secondaryTriggers = [ //The triggers for the specific response the bot will make. The script will check through them in this order. Note that some of these are offensive, but that is so the bot 
        ...
        ["shut u", "shut y", "no one likes you", "nonce", "bastard", "gtfo", "shut the", "suck", "cringe", "shut yo", "jerk", "idiot", "trash", "stupid", "hate", "noob", "dumb", "garbage", "terrible", "horrible", "cock", "pussy", "dick", "shit", "fuck", "stfu", "retard", "go die", "die bot", "die nice", "kys", "kill", "bitch", "cunt", "fag", "nigge"],
